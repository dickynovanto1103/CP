...
int main(){
	...
	while(tc--){
		...
		for(i=0;i<n;i++){
			...
			for(j=0;j<m;j++){
				point b1 = b[j],b2 = b[j+1];
				point c;
				minim = min(minim, distToLineSegment(b1, a1, a2, c));
				minim = min(minim, distToLineSegment(b2, a1, a2, c));
				minim = min(minim, distToLineSegment(a1, b1, b2, c));
				minim = min(minim, distToLineSegment(a2, b1, b2, c));
